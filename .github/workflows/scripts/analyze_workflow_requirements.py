...
class WorkflowRequirementsAnalyzer:
    ...
    def analyze_workflow(self, workflow_file):
        ...
        if "KSampler" in self.gpu_memory_estimates:
            ...
            memory_required += (batch_size - 1) * self.gpu_memory_estimates["KSampler"][
                "per_batch"
            ]
        ...
        workflow_result["memory_required"]["recommended"] = max(
            workflow_result["memory_required"]["recommended"],
            int(memory_required * 1.5),
        )
    ...
    def analyze_all_workflows(self):
        ...
        results = {
            ...
            "aggregate": {
                ...
                "custom_nodes": {},
                "python_packages": {},
                "memory_requirements": {"min": 0, "max": 0, "workflows_by_memory": {}},
            },
        }
        ...
        for workflow in results["workflows"]:
            ...
            if (
                memory_key
                not in results["aggregate"]["memory_requirements"][
                    "workflows_by_memory"
                ]
            ):
    ...
    def generate_markdown_report(self, results):
        ...
        report.append(
            f"- Total workflows analyzed: {results['summary']['total_workflows']}"
        )
        report.append(
            f"- Successfully analyzed: {results['summary']['analyzed_workflows']}\n"
        )
        ...
        for memory, workflows in results["aggregate"]["memory_requirements"][
            "workflows_by_memory"
        ].items():
    ...
    def save_results(self, results):
        ...
        json_output_path = os.path.join(
            self.output_dir, "workflow_requirements_results.json"
        )
        ...
        markdown_output_path = os.path.join(
            self.output_dir, "workflow_requirements_report.md"
        )
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        default="workflow_requirements_output",
