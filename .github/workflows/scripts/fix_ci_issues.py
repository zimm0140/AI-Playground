        ...
        try:
            ...
            try:
                ...
                if 'try:' in content and 'from web_api import app' in content:
                    pattern = re.compile(r"try:\s*from web_api import app\s*except ImportError:\s*from service.web_api import app", re.DOTALL)
                    fixed_content = pattern.sub("""        try:
            from web_api import app
        except ImportError:
            from service.web_api import app""", content)
                    ...
                    if fixed_content != content:
                        ...
                        try:
                            ...
                            print("  - Syntax error persists, creating minimal working version")
