#!/usr/bin/env python3
"""
Generate Hardware Detection Module Script

This script generates the core hardware detection module for CI environments.
It creates a functional tools/hardware/hardware_detection.py file with all
...
def debug_print(message, level="INFO"):
    ...
    print(f"[GENERATE_HW_MODULE:{level}] {message}")
...
def main():
    """Main function."""
    debug_print("Starting hardware detection module generation...")

    if not ensure_directory_structure():
        debug_print("Failed to create directory structure", "ERROR")
        return 1
    ...
    debug_print("Hardware detection module generation completed successfully")
    return 0
