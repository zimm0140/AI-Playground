...
def main():
    ...
    if os.path.exists('ci_artifacts/workflow_validation/workflow_validation_results.json'):
        with open('ci_artifacts/workflow_validation/workflow_validation_results.json') as f:
            results = json.load(f)
    ...
    if os.path.exists('ci_artifacts/workflow_requirements/workflow_requirements_results.json'):
        with open('ci_artifacts/workflow_requirements/workflow_requirements_results.json') as f:
            results = json.load(f)
