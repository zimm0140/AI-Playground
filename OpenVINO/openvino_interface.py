...
class LLMInterface(ABC):
    """
    Abstract interface for Large Language Model implementations.

    This abstract base class defines the required methods that any LLM
    implementation must provide to be compatible with the OpenVINO framework.
