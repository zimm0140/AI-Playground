"""
OpenVINO LLM Parameters Module
-----------------------------
This module defines parameter classes used to configure and control
Large Language Model (LLM) inference through the OpenVINO runtime.
...
class LLMParams:
    """
    Parameter class for OpenVINO LLM inference.
    
    This class encapsulates all configuration parameters needed for text generation
    with Large Language Models optimized for OpenVINO runtime. It handles both
