...
3. **pyproject.toml**: Modern PEP 621 configuration
...
3. **XPU Integration Example**: Demo of hardware-aware configuration
...
4. Run commands in the optimized environment:
