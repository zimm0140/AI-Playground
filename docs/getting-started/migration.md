...
1. **Missing dependencies**: Run `python setup_hardware_env.py --dev` to install all dependencies
2. **Configuration errors**: Delete your `uvfast.json` file to regenerate the default configuration
3. **Workflow compatibility**: Use the provided conversion tool for workflows
