...
# Hardware Compatibility Testing {#hardware-compatibility-testing}
...
## Example Compatibility Matrix {#example-compatibility-matrix}
...
## Integration with Other CI Features {#integration-with-other-ci-features}
...
## Hardware Compatibility Advisor {#hardware-compatibility-advisor}
...
### Optimized Requirements {#optimized-requirements}
...
### Using the Auto-fix Tool {#using-the-auto-fix-tool}
...
### Auto-fix in Pull Requests {#auto-fix-in-pull-requests}
...
### Auto-fix Report {#auto-fix-report}
