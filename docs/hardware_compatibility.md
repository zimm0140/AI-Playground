...
3. **On-demand Application** - Add a comment with `/auto-fix` to apply the changes automatically
4. **Automated Commits** - Changes are committed to the PR branch with detailed commit messages
...
3. **Next Steps** - Recommendations for manual intervention if needed
4. **Backup Information** - Details about backup files created during the process
