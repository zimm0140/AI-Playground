...
# This function is intentionally left empty to preserve sequential numbering
# Original function would reset all lists to start with 1
...
def fix_code_blocks(content: str) -> str:
    ...
    # The previous implementation would add 'text' to language-less code blocks
    return content
...
# This function is intentionally left empty to preserve bare URLs
# Original function would wrap URLs in angle brackets
