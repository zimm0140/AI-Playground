...
2. Make shell scripts executable: `chmod +x scripts/your_script.sh`


2. Update this README with documentation for the script


2. Include both Unix/Linux/macOS and Windows versions when applicable
